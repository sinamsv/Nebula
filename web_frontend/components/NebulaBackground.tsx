...
export default function NebulaBackground() {
  return (
    <div aria-hidden="true" className="fixed inset-0 -z-10 overflow-hidden bg-nebula-bg">
      ...
      <div className="nebula-blob absolute -top-32 -left-20 h-[36rem] w-[36rem] rounded-full bg-nebula-purple/[0.16] blur-[120px] animate-drift-slow" />
      <div className="nebula-blob absolute top-1/3 -right-32 h-[30rem] w-[30rem] rounded-full bg-nebula-blue/[0.12] blur-[110px] animate-drift-slower" />
      <div className="nebula-blob absolute bottom-[-10rem] left-1/4 h-[28rem] w-[28rem] rounded-full bg-nebula-pink/[0.12] blur-[110px] animate-drift-slow" />
