...
class MemoryCommands(commands.Cog):
    ...
    @app_commands.command(name='memory_stats', description='Show your Nebula memory usage (shared across all platforms you use).')
    ...
    @app_commands.command(name='memory_reset', description='Clear your Nebula conversation memory (affects all platforms you use).')
